...
export default function ResumeMain(){     
    return(
    <div className="relative flex flex-row w-screen h-[285vh] pt-16 lg:px-20 md:px-12 sm:px-8 max-sm:px-8 bg-white">
      {/*About fixed*/}
      ...
      <div className="flex-1 flex-col">
        {/*1번째 레이어*/}
        <div className="sticky top-[8%] w-full h-1/3 flex justify-center text-white font-semibold z-0 mb-10">
          <div className="w-[90%] h-[95%] border border-gray-300 rounded-xl">
            <ResumeLayer1/>
          </div>
        </div>
        {/*2번째 레이어*/}
        <div className="sticky top-[8%] w-full h-2/3  flex justify-center text-white  font-semibold z-10 ">
