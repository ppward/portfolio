...
export default function SkillLayer(){
    ...
    <div className="relative z-10 flex flex-col w-full h-full">
        ...
        <div className="flex flex-1 flex-row justify-center">
            <div className="flex flex-col justify-between w-[42%] bg-blue-600 m-2 p-4 rounded-xl">
            ...
            <div className="flex flex-col justify-between w-[42%] bg-blue-900 m-2 p-4 rounded-xl">
