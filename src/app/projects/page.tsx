            ...
            {projects.map((key, idx)=>(
                    ...
                    <div className="w-[calc(65%-130px)] lg:ml-20 md:ml-10 sm:ml-5 max-sm:ml-5 font-paperlogy text-black lg:text-lg md:text-base: sm:text-sm max-sm:text-sm font-bold">
                        <div className="flex items-center">
                            ...
                            {key.particular? <div className="ml-3 lg:w-5 lg:h-5 md:w-4 md:h-4 sm:w-3 sm:h-3 max-sm:w-3 max-sm:h-3 bg-yellow-400 rounded-full"/>:<div/> }
                        </div>
                        <p>{key.purpose}</p>
                        <br/>
                        <p className="lg:text-xl md:text-base sm:text-sm max-sm:text-base text-blue-600">Describe</p> 
