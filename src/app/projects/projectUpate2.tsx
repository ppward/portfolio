            ...
            <AnimatePresence mode="wait">
                {selectedIndex === null ? (
                    ...
                    >
                        ...
                        >
                            <h1 className="text-6xl font-paperlogy font-black text-blue-600 mb-4">PROJECTS</h1>
                        ...
                        <div className="grid grid-cols-3 gap-6">
                            {items.map((item, index) => (
                                <motion.div
                                    key={item.id}
                                    className="aspect-square bg-white border-4 border-blue-900 rounded-2xl overflow-hidden cursor-pointer shadow-xl hover:shadow-2xl transition-shadow"
